...
!function(global, factory) {
    ...
    const injectQContainer = containerEl => {
        directSetAttribute(containerEl, "q:version", "1.5.5"), directSetAttribute(containerEl, "q:container", "resumed"), 
    ...
    exports.useVisibleTaskQrl = useVisibleTaskQrl, exports.version = "1.5.5", exports.withLocale = function(locale, fn) {
