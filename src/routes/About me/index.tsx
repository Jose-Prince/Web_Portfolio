        ...
        <>
            ...
            <div class={styles.aboutDisplay}>
                ...
                <div style={{display: 'flex'}}>
                    <Reference link="https://www.linkedin.com/in/jos%C3%A9-alejandro-prince-martinez-179ba622a/" ref='https://cdn1.iconfinder.com/data/icons/logotypes/32/circle-linkedin-512.png' ancho="150px"/>
                    <Reference link="https://github.com/Jose-Prince" ref='https://www.svgrepo.com/show/217753/github.svg' ancho="150px"/>
                </div>
            </div>
        </>
    )
